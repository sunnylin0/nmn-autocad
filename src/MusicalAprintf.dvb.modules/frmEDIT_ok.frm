VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmEDIT_ok 
   Caption         =   "¹Ï¶ô¥Î EDIT"
   ClientHeight    =   5844
   ClientLeft      =   48
   ClientTop       =   336
   ClientWidth     =   9660
   OleObjectBlob   =   "frmEDIT_ok.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmEDIT_ok"
...
'*******´¡¤J¨C¦æªº¤p¸`½u'**************************************************************************************'
                Call atDraw_BarLine(the_pt, the_track, the_line, the_measure, the_alltempo)
                ...
                If s1.notes(0).mnote = "." Then
                    Set tmp_xy = atTableDraw(ppnt, tmp_track, G.durationIndex, True)
                Else
...
'
    ...
    MeasureDEF = (G.mete * PARTITION_DEF / (G.mete2 / 4))  '­pºâ¨C¤p¸`¦³¦h¤Ö³æ¦ì (4©ç¥þ­µ²Å¦³¦h¤Ö³æ¦ì)
    ...
    Col = the_alltempo / PARTITION_DEF  '¨ú±o²{¦b¤p¸`ªº²Ä´X©ç
